...
<Figure src={figure1} caption="譜例1" maxHeightPx={90} />
<Figure src={figure2} caption="譜例2 （第2主題からブルックナー・リズムを引用）" maxHeightPx={90} />
...
<Figure src={figure3} caption="譜例3" maxHeightPx={90} />
<Figure src={figure4} caption="譜例4" maxHeightPx={90} />
