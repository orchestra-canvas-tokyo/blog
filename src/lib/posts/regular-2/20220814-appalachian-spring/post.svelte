<script lang="ts" context="module">
  ...
  export const metadata: Metadata = {
    published: true,
    publicatedAt: '2022-08-14T20:00:01+0900',
...
<h4>第5場 - Molto Moderato - Allegro - Presto - Meno</h4>
...
<h4>第6場 - As at first (Slowly)</h4>

<p>第1場のリプライズと移行部を兼ねる場面。</p>

<h4>第7場 - Doppio moviemento</h4>

<p>
  シェーカー教の民謡《Simple
  Gifts》をクラリネットソロが引用して始まる。夫婦の日々を描く。民謡は5つの変奏となって夫婦のダンスを導き、ヴァイオリンのアルペジオが盛り上がりを見せた後、オーケストラ全体による協奏によって喜びは最高潮に達する。
</p>

<h4>第8場 - Moderato - Piú Mosso - Andante(very calm)</h4>
...
<Reference>
  <li>
    Fink, Michael. 2020. “THE STORY BEHIND: Copland’s Appalachian Spring.” <cite
      >Rhode Island Philharmonic Orchestra & Music School</cite
    >, November 8, 2021. <UrlLink
      url="https://www.riphil.org/blog/the-story-behind-coplands-appalachian-spring"
    />
  </li>
  <li>
    Halpern, Susan. 2018. “Appalachian Spring...Aaron Copland,” <cite
      >Susan Halpern Program Notes</cite
    >, November 8, 2021. <UrlLink
      url="https://www.halpernprogramnotes.com/copeland-appalachian-spring"
    />
  </li>
  <li>MacDonald, Malcolm. 1999. Copland Ballet Music, London: Boosey & Hawkes.</li>
  <li>
    Machlis, Joseph. 2016. “Aaron Copland,” <cite>Encyclopædia Britannica</cite>, November 8, 2021. <UrlLink
      url="https://www.britannica.com/biography/Aaron-Copland#ref178798"
    />
  </li>
</Reference>
